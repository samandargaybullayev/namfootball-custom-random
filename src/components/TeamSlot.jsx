...
const TeamSlot = ({ slotId, availableTeams, animationTeams = null, validTeams = null, isLocked, selectedTeam, onSelect, isAnyAnimating, setAnimating, enableRoulette = false, customText = null, customGradient = null }) => {
